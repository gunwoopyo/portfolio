...
```#C++``` ```#Rockey Linux``` ```#Maria DB``` ```#Qt```  
* 인턴 1차 프로젝트입니다.
* Linked List를 통해 Class로 구현
...
* 게이트웨이의 CPU 및 메모리 부하율 등 정보 모니터링
* 포트 정보 및 상태, BPS(PPS) 트래픽 실시간 수집 및 모니터링, 포트 부하 분석
* 라우팅 테이블, ARP 테이블 구현
<br>
...
* 사용자 맞춤 활동 추천 및 정신 건강을 위한 기능 구현
* GPT API 및 정신 건강 검사 활용
